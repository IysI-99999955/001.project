...
class SentimentAnalyzer:
    ...
    def __init__(self, model_name: str = "beomi/kcbert-base", batch_size: int = 8, force_cpu: bool = False):
...
def get_sentiment_analyzer(model_name: str = "beomi/kcbert-base", force_cpu: bool = False) -> SentimentAnalyzer:
    """
    감정 분석기 인스턴스를 반환합니다.
...
RECOMMENDED_MODELS = [
    ...
    "beomi/kcbert-base",                    # 한국어 댓글 데이터로 학습된 BERT(현재 사용)
    "alsgyu/sentiment-analysis-fine-tuned-model",  # 감정 분석 파인튜닝 모델 (not good)
